...
vim.keymap.set('n', '<Leader>p', function() Snacks.picker.files() end)
-- vim.keymap.set('n', '<Leader>po', '<cmd>Telescope buffers<CR>')
vim.keymap.set('n', '<Leader>po', function() Snacks.picker.buffers() end)
-- vim.keymap.set('n', '<Leader>pr', '<cmd>Telescope resume<CR>')
vim.keymap.set('n', '<Leader>pr', function() Snacks.picker.resume() end)
...
-- SNACKS
vim.keymap.set('n', '<Leader>s', function() Snacks.picker.smart() end)
vim.keymap.set('n', '<Leader>se', function() Snacks.explorer() end)
vim.keymap.set('n', '<Leader>sB', function() Snacks.picker.grep_buffers() end)
vim.keymap.set('n', '<Leader>sz', function() Snacks.zen() end)
...
vim.keymap.set({ 'n', 'i' }, '<F2>', vim.lsp.buf.rename)                                        -- rename definition
...
vim.keymap.set('i', '/fnc', 'function ()<Esc>hi')
